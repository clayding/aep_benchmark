...
THRIFTSERVER_CONFIG="--num-executors 2 \
        ...
        --conf spark.sql.oap.fiberCache.persistent.memory.initial.size=220g \
        --conf spark.sql.oap.fiberCache.persistent.memory.reserved.size=50g \
